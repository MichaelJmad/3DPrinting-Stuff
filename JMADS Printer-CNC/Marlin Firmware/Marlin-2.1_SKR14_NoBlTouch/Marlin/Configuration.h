...
#define STRING_CONFIG_H_AUTHOR "(JMAD Ender3 SKR1_4 6/18/22)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "JMAD Printer"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -20, -0.4 }
